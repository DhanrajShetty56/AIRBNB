...
icon = Image.open("Airbnb-Logo.wine.png")
st.set_page_config(page_title= "Airbnb Data Visualization | By Aarif",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Aarif*!
...
if selected == "Home":
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.image("Airbnb-Logo.wine.png")
